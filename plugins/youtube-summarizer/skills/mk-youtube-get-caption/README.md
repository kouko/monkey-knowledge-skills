...
| Location | Purpose |
|----------|---------|
| `/tmp/monkey_knowledge/youtube/captions/{YYYYMMDD}__{video_id}__{title}.{lang}.srt` | Downloaded SRT subtitle files |
| `/tmp/monkey_knowledge/youtube/captions/{YYYYMMDD}__{video_id}__{title}.{lang}.txt` | Plain text version (no timestamps) |
